Aif game.PlaceId == 2753915549 then
    World1 = true
...
local Window = OrionLib:MakeWindow({Name = "nigga hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "nigga hub"})
